...
public class MainActivity extends AppCompatActivity {
    ...
    public void addOperations(String operation){
        ...
        if(!currentValue.equals("")) {
            ...
            if (last.equals("0") || last.equals("1") || last.equals("3") || last.equals("4") || last.equals("5") || last.equals("6") || last.equals("7") || last.equals("8") || last.equals("9")) {
                ...
                //Will not allow user to add operation if it does not pass the above requirments
